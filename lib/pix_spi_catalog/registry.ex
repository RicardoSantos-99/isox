defmodule PixSpiCatalog.Registry do
  @moduledoc """
  Descobre os módulos `PixSpiCatalog.Generated.<Mensagem>.<Versao>` já
  ...
  def generated_modules do
    ...
    for module <- Application.spec(:pix_spi_catalog, :modules) || [],
        module != PixSpiCatalog.Generated.Head001,
        module |> Atom.to_string() |> String.starts_with?("Elixir.PixSpiCatalog.Generated."),
  ...
  def parse(xml) do
    ...
    case Enum.find(generated_modules(), &(&1.namespace() == namespace)) do
      ...
      module ->
        with {:ok, term} <- module.parse(xml) do
