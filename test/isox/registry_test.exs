defmodule Isox.RegistryTest do
  ...
  test "generated_modules encontra os módulos reais já carregados" do
    ...
    assert Isox.Generated.Pibr001.V1_3 in modules
    assert Isox.Generated.Pacs008.V1_16 in modules
    refute Isox.Generated.Head001 in modules
  end
  ...
  test "parse despacha para o módulo certo pelo namespace" do
    assert {:ok, Isox.Generated.Pibr001.V1_3, term} = Registry.decode(@xml_pibr001)
